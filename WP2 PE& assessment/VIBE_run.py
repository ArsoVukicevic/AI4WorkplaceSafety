...
import os
#os.environ['PYOPENGL_PLATFORM'] = 'egl' #ovo jebe na windowsu, komentarisao sam ga
...
#        print('Koristice se:' + torch.cuda.get_device_name(device))
    ...
    image_folder, num_frames, img_shape = video_to_images(video_file, img_folder="tmp", return_info=True)
    ...
    if args.tracking_method == 'pose':
        ...
        mot = MPT(device=device, batch_size=args.tracker_batch_size, display=args.display, detector_type=args.detector, output_format='dict', yolo_img_size=args.yolo_img_size)
    ...
    vibe_faces = get_smpl_faces()
    joblib.dump(vibe_faces, os.path.join(output_path, "vibe_faces.pkl"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vid_file', type=str, default='ETF\\konf_rad\\ETF_arso.mp4',
    ...
    parser.add_argument('--yolo_img_size', type=int, default=608,
                        help='input image size for yolo detector')

    parser.add_argument('--tracker_batch_size', type=int, default=2,
                        help='batch size of object detector used for bbox tracking')

    parser.add_argument('--staf_dir', type=str, default='F:\\_ARSO_DeepLearningCode\\_BazaArhitektura\\PoseEstimation\\VIBE MaxPlank\\openpose-staf',
...
#https://www.gitmemory.com/mkocabas
# ovo radi:  python demo.py --vid_file PUSH.mp4 --output_folder output/ --display